...
public class ProcessClientChannelHandler extends SimpleChannelInboundHandler<DatagramPacket> {
    ...
    protected void messageReceived(ChannelHandlerContext channelHandlerContext, DatagramPacket datagramPacket) throws Exception {
        ...
        if (messageHeader.getMessageType() == MessageType.PREPROCESS_RES) {
            ...
            logger.debug("[PreProcessServerChannelHandler] RECV PreProcessResponse(statusCode={}, reason={})", statusCode, reason);
            ...
            logger.debug("[PreProcessServerChannelHandler] RECV EndLiveMediaProcessResponse(statusCode={}, reason={})", statusCode, reason);
        } else {
            logger.debug("[PreProcessServerChannelHandler] RECV UnknownResponse (header={})", messageHeader);
        }
    }
