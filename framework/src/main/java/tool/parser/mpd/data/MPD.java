...
import tool.parser.mpd.data.descriptor.Descriptor;
import tool.parser.mpd.support.Utils;
...
@JacksonXmlRootElement(localName = "MPD", namespace = tool.parser.mpd.data.MPD.NAMESPACE)
public class MPD {
    ...
    @JacksonXmlProperty(localName = "ServiceDescription", namespace = NAMESPACE)
    ...
    private MPD(String schemaLocation, List<ProgramInformation> programInformations, List<ServiceDescription> serviceDescriptions, List<BaseURL> baseURLs, List<String> locations,
    ...
    public static class Builder {
        private static final String DEFAULT_SCHEMA_LOCATION = "urn:mpeg:dash:schema:mpd:2011 http://standards.iso.org/ittf/PubliclyAvailableStandards/MPEG-DASH_schema_files/validation_xsd/DASH-MPD.xsd";
        ...
        public Builder withServiceDescriptions(List<ServiceDescription> serviceDescriptions) {
            this.serviceDescriptions = serviceDescriptions;
            return this;
        }
        ...
        public MPD build() {
            return new MPD(schemaLocation, programInformations, serviceDescriptions, baseURLs, locations, periods, metrics, essentialProperties, supplementalProperties, utcTimings, id, profiles, type, availabilityStartTime, availabilityEndTime, publishTime, mediaPresentationDuration, minimumUpdatePeriod, minBufferTime, timeShiftBufferDepth, suggestedPresentationDelay, maxSegmentDuration, maxSubsegmentDuration);
        }
    }
}
